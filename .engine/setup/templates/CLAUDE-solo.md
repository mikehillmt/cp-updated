...
```bash
node .engine/scripts/generate-image.js "Professional team in modern office celebrating a product launch" campaigns/[campaign-name]/output-assets/images/hero.png
```
...
node .engine/scripts/html-to-pdf.js campaigns/[campaign]/output-assets/html/lead-magnet.html campaigns/[campaign]/output-assets/pdfs/lead-magnet.pdf
...
**Alex:** Created `campaigns/acme-launch/` with output-assets folder.
...
Upload them to `brand-kit/` (shared across campaigns) or `campaigns/acme-launch/brand-kit/` (campaign-specific), or describe your brand and I'll create the docs.
